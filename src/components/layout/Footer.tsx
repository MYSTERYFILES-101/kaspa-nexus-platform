...
const footerLinks = {
  ...
  resources: [
    { label: 'API Docs', href: 'https://api.kaspa-nexus.io/docs', external: true },
    { label: 'FAQ', href: '/faq' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <div>
                <span className="text-lg font-bold text-gradient-primary">KASPA</span>
        ...
        <div className="mt-12 pt-8 border-t border-glass-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-text-muted">
            &copy; {currentYear} KASPA-NEXUS. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
            ...
            {/* Discord */}
            <a
              href="https://discord.gg/kaspa-nexus"
              target="_blank"
              rel="noopener noreferrer"
              className="text-text-muted hover:text-primary transition-colors"
              aria-label="Discord"
